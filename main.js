...
// 깃허브 액션에서는 Secrets를 바로 사용하기 때문에 이 코드가 실행되지 않습니다.
...
const PROJECT_ID = process.env.PROJECT_ID; // 프로젝트의 고유 ID
const FILE_ID = process.env.FILE_ID; // 파일의 고유 ID
...
async function createElements() {
  // 🚨🚨 이 URL이 바로 핵심입니다. PROJECT_ID를 포함합니다. 🚨🚨
